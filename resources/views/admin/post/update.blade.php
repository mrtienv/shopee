                ...
                <form method="post" action="">
                    ...
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <div class="card">
                                <div class="card-header"><strong>Box nhà cái</strong></div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <div class="col-5">
                                                    <label>Mô tả nhà cái</label>
                                                    <input class="form-control" name="optional[nhacai_description]" value="{{!empty($optional->nhacai_description) ? $optional->nhacai_description : ''}}" type="text" placeholder="Tên nhà cái">
                                                </div>
                                                <div class="col-5">
                                                    <label>Logo</label>
                                                    <input class="form-control" name="optional[nhacai_banner]" id="hd_banner" value="{{!empty($optional->nhacai_banner) ? $optional->nhacai_banner : ''}}" type="text" placeholder="Logo">
                                                </div>
                                                <div class="col-2">
                                                    <label>&nbsp;</label>
                                                    <div class="form-control btn" onclick="upload_file('chosefile','banner')">Chọn ảnh</div>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-6">
                                                    <label>Text 1</label>
                                                    <input class="form-control" name="optional[nhacai_text1]" value="{{!empty($optional->nhacai_text1) ? $optional->nhacai_text1 : ''}}" type="text" placeholder="Text 1">
                                                </div>
                                                <div class="col-6">
                                                    <label>Link 1</label>
                                                    <input class="form-control" name="optional[nhacai_link1]" value="{{!empty($optional->nhacai_link1) ? $optional->nhacai_link1 : ''}}" type="text" placeholder="Link 1">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-6">
                                                    <label>Text 2</label>
                                                    <input class="form-control" name="optional[nhacai_text2]" value="{{!empty($optional->nhacai_text2) ? $optional->nhacai_text2 : ''}}" type="text" placeholder="Text 2">
                                                </div>
                                                <div class="col-6">
                                                    <label>Link 2</label>
                                                    <input class="form-control" name="optional[nhacai_link2]" value="{{!empty($optional->nhacai_link2) ? $optional->nhacai_link2 : ''}}" type="text" placeholder="Link 2">
                                                </div>
                                            </div>
